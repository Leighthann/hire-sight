      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <h3 className="mb-1 text-lg font-semibold text-white">
            {isDragActive ? "Drop the files here" : "Upload Resumes"}
          </h3>
          <p className="mb-4 text-sm text-gray-400">Drag & drop resume files or click to browse</p>
          <Button type="button" size="sm" className="bg-gradient-primary">
            Select Files
          </Button>
          <p className="mt-2 text-xs text-gray-500">PDF, DOC, DOCX up to 5MB</p>
        </div>
      </div>
      ...
      {files.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="flex justify-end">
            <Button onClick={uploadFiles} disabled={isUploading} className="bg-gradient-primary">
              {isUploading ? (
                <>
